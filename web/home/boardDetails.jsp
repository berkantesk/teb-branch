...
<html>
    ...
    <body>
        <div class="profil" style="min-width:990px">
            ...
            <div class="profile-field-content">
                <div class="tagprofile-utility" style="width: 289px;border-right: 1px solid #e5e5e5;border-color: #e5e5e5;margin-right: 29px;position: relative;display:inline-block">
                    <div class="pic" style="display:inline-block"><img src="../<%=currentBoard.getBoardImageLocation()%>" alt="Koç Üniversitesi" class="profile-image" style="width: 138px;height: 138px;"></div>
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            %>
            <font style="color: #c7254e">To surf click links on the left!</font>
            <%            } else {
            %>
