...
public class BoardBar {
    ...
    public static LinkedList<BoardBar> compute(int boardId, LinkedList<BoardBar> _initalList) throws InstantiationException, IllegalAccessException, SQLException {
        CallableStatement callStmt = null;
        ResultSet rs = null;
        Connection dbConn = PostgresConnection.getConnection();

        if (_initalList == null) {
            _initalList = new LinkedList<BoardBar>();
        }
    ...
    public static LinkedList<BoardBar> getChildren(int boardId, LinkedList<BoardBar> _initalList) {
    ...
    public static void main(String[] args) throws IllegalAccessException, InstantiationException, SQLException {
        LinkedList<BoardBar> panolar = BoardBar.compute(22, null);
